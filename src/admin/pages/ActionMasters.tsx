  ...
  return (
    <IonPage>
            ...
            <div className="pages-container">
              ...
              <div className="pagination-container">
                <div className="pagination-info">
                  <p>
                    Showing {startIndex + 1} to {Math.min(endIndex, filteredAndSortedActions.length)} of {filteredAndSortedActions.length} actions
                  </p>
                </div>
      ...
      <IonFab vertical="bottom" horizontal="end" slot="fixed">
        <IonFabButton className="fab-add-page" onClick={handleAddAction}>
          <IonIcon icon={addOutline} />
        </IonFabButton>
      </IonFab>
