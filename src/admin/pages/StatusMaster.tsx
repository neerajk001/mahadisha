        ...
        <div className="main-content" id="dashboard-content">
          ...
          <IonContent className="manage-pages-content">
            <div className="pages-container">
              ...
              {/* Modern Statuses Grid */}
              {viewMode === 'grid' ? (
                <div className="pages-grid">
                  {currentStatuses.map((status) => (
                    <div key={status.id} className="page-card">
                      <div className="page-card-header">
                        <div className="page-card-icon">
                          <IonIcon icon={checkmarkOutline} />
                        </div>
                        <div className="page-card-title">
                          <h3 className="page-card-name">{status.name}</h3>
                          <div className="page-card-url">Status</div>
                        </div>
                      </div>
              ...
              <div className="pagination-container">
                <div className="pagination-info">
                  <p>
                    Showing {startIndex + 1} to {Math.min(endIndex, filteredAndSortedStatuses.length)} of {filteredAndSortedStatuses.length} statuses
                  </p>
                </div>
